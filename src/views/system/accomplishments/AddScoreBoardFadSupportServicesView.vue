<script setup>
import ScoreboardForm_fadsupportservices from '@/components/system/accomplishments/scoreboard/ScoreboardForm_fadsupportservices.vue'
  ...
  >
    ...
    <template #content>
      <v-container>
        ...
        <ScoreboardForm_fadsupportservices v-bind="formProps" />
