<script setup>
import ScoreboardForm_fadexternal from '@/components/system/accomplishments/scoreboard/ScoreboardForm_fadexternal.vue'
  ...
  >
    ...
    <template #content>
      <v-container>
        <v-card class="mb-7">
          <template #title>
            <span class="text-h6 font-weight-bold">
              <v-breadcrumbs :items="['Scoreboard', 'External Transaction']">
                <template #prepend>
        ...
        <ScoreboardForm_fadexternal v-bind="formProps" />
